...
<!--[if gt IE 9]><!--><html class="no-js" lang="en"><!--<![endif]-->
    ...
    <body id="page" onclick="window.location='http://www.alumnimeet.iitkgp.ernet.in/home.php'">
		<h1 style="font:bold 20px Tahoma">This site works best when viewed on Google Chrome</h1><h2 style="float:left;font:bold 20px Tahoma">Click anywhere to exit the invitation</h2>
